...
public class CategoryController {
    ...
    @PostMapping("")
    public ResponseEntity<?> insertCategories(@Valid @RequestBody CategoryDTO categoryDTO, BindingResult bindingResult){
    ...
    public ResponseEntity<?> getAllCategories(
        ...
        for(CategoryDTO categoryDTO : categoryDTOS){
            for (CategoryDTO.ProductDTO productDTO : categoryDTO.getProducts()){
                productDTO.add(linkTo(methodOn(ProductController.class).getProductById(productDTO.getId())).withSelfRel());
            }

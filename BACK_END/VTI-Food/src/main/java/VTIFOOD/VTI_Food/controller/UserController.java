...
public class UserController {
    ...
    public ResponseEntity<?> creatUser(@Valid @RequestBody UserRequestDTO userRequestDTO) throws DataNotFoundException, PermissionDenyException {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponse> login(@RequestBody @Valid UserLoginDTO userLoginDTO, HttpServletRequest
                                               request){
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateUser(@PathVariable Long id, @Valid @RequestBody UserUpdateDTO userUpdateDTO) throws DataNotFoundException {

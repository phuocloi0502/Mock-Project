        ...
        httpSecurity
                ...
                .authorizeHttpRequests(request -> {
                    request.requestMatchers(
                            ...
                            .requestMatchers(HttpMethod.GET, String.format("%s/carts/**", apiPrefix)).hasAnyRole("ADMIN", "USER")
                            .requestMatchers(HttpMethod.GET, String.format("%s/carts", apiPrefix)).hasAnyRole("ADMIN", "USER")
                            .requestMatchers(HttpMethod.POST, String.format("%s/carts/**", apiPrefix)).hasRole("USER")
                            .requestMatchers(HttpMethod.DELETE, String.format("%s/carts/**", apiPrefix)).hasAnyRole("ADMIN", "USER")
                            .requestMatchers(HttpMethod.PUT, String.format("%s/products/**", apiPrefix)).hasRole("USER")

                            .requestMatchers(HttpMethod.GET, String.format("%s/order_details/**", apiPrefix)).hasAnyRole("ADMIN", "USER")
                            ...
                            .requestMatchers(HttpMethod.GET, String.format("%s/cart_details/**", apiPrefix)).hasAnyRole("ADMIN", "USER")
                            .requestMatchers(HttpMethod.PUT, String.format("%s/cart_details/**", apiPrefix)).hasRole("ADMIN")
                            .requestMatchers(HttpMethod.POST, String.format("%s/cart_details/**", apiPrefix)).hasRole("USER")
                            .requestMatchers(HttpMethod.GET, String.format("%s/cart_details/**", apiPrefix)).hasAnyRole("USER", "ADMIN")
                            .requestMatchers(HttpMethod.DELETE, String.format("%s/cart_details/**", apiPrefix)).hasRole("ADMIN")
                            .anyRequest()
                            .authenticated();
                })
                .csrf(AbstractHttpConfigurer::disable);
